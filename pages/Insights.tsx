    ...
    <div className="animate-fadeIn">
      ...
      <section className="bg-hbrz-blue py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <span className="text-hbrz-gold text-xs font-bold uppercase tracking-[0.4em] mb-4 block">Knowledge Hub</span>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Institutional <span className="text-hbrz-gold">Insights</span></h1>
          <p className="text-xl text-gray-300 font-light max-w-3xl mx-auto leading-relaxed">
            Analytical perspectives on global trade governance, institutional strengthening, and structured operational frameworks. This section presents HBRZ’s thematic focus areas for research, analysis, and future thought leadership.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {papers.map((paper, idx) => (
              <div key={idx} className="group border border-gray-100 p-10 bg-white hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-xl flex flex-col justify-between h-full border-t-4 hover:border-t-hbrz-gold border-t-hbrz-blue">
                <div>
                  <div className="text-hbrz-gold text-[10px] font-bold uppercase tracking-[0.3em] mb-6 border-b border-gray-50 pb-2">{paper.category}</div>
                  <h4 className="text-2xl font-bold text-hbrz-blue mb-6 group-hover:text-hbrz-gold transition-colors leading-tight">{paper.title}</h4>
                  <p className="text-gray-500 text-sm leading-relaxed mb-8 font-light italic">{paper.desc}</p>
                </div>
      ...
      <section className="py-24 bg-gray-50 border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-hbrz-blue mb-6">Subscribe to Institutional Briefs</h2>
          ...
          <p className="mt-6 text-[10px] text-gray-400 uppercase tracking-widest">
            HBRZ values your privacy and strictly adheres to professional communication standards.
          </p>
        </div>
      </section>
    </div>
