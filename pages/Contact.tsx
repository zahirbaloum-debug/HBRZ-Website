    ...
    <div className="animate-fadeIn">
      ...
      <section className="bg-gray-50 py-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-hbrz-blue mb-4">Connect With HBRZ</h1>
          <p className="text-hbrz-gold font-medium uppercase tracking-widest text-sm">Global Coordination. Local Expertise.</p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-hbrz-blue mb-8">Our Global Locations</h2>
              ...
              <div className="space-y-12">
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-hbrz-blue mb-2 uppercase tracking-wide">Nigeria Operations</h3>
                    <p className="text-gray-600 mb-1">HBRZ Global Purity Trading and Consulting Services Ltd</p>
                    <p className="text-gray-600 font-semibold mb-3">Kano, Nigeria</p>
                    <p className="text-sm text-gray-500">Phone: +234 813 453 6052</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-hbrz-blue mb-2 uppercase tracking-wide">United States (Affiliates)</h3>
                    <p className="text-[10px] font-bold text-hbrz-gold uppercase tracking-widest mb-2">Registered in Delaware and Virginia</p>
                    <p className="text-gray-600 mb-1">HBRZ Global Purity Trading and Consulting Services LLC</p>
                    ...
                    <p className="text-sm text-gray-500">Phone: +1 571 268 4110</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-hbrz-blue mb-2 uppercase tracking-wide">Email Inquiries</h3>
                    <p className="text-gray-600">Info@hbrzglobalpurity.com</p>
                    <p className="text-xs text-gray-400 mt-2 italic">Expect a response within 24-48 business hours.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
              <h2 className="text-2xl font-bold text-hbrz-blue mb-6">Institutional Inquiry Form</h2>
              ...
              {submitted ? (
                <div className="bg-green-100 border border-green-200 text-green-800 p-6 rounded-lg text-center">
                  ...
                  <p>Our compliance or strategic advisory team will review your inquiry and contact you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select value={inquiryType} onChange={(e) => setInquiryType(e.target.value)} required className="w-full px-4 py-3 rounded border border-gray-300 focus:border-hbrz-gold focus:ring-1 focus:ring-hbrz-gold outline-none transition-all bg-white">
                      ...
                      <option value="compliance">Compliance & Governance Inquiry</option>
                    </select>
                  </div>
                  <div>
                  ...
                  <p className="text-[10px] text-gray-400 text-center italic">
                    By submitting this form, you acknowledge that HBRZ operates under strict AML/KYC protocols.
                  </p>
                </form>
              )}
            </div>
