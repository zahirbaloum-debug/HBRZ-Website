        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <div className="inline-block px-3 py-1 border border-hbrz-gold text-hbrz-gold text-xs font-bold uppercase tracking-[0.2em] mb-6 rounded-sm bg-hbrz-gold/10">
              Strategic Trade Intermediation and Institutional Advisory
              Excellence
            </div>
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed font-light max-w-2xl">
              HBRZ Global Purity is structured to provide institutional
              consulting and advisory services focused on capacity building and
              organizational strengthening, general information technology (IT)
              advisory and systems support, and governance-aligned coordination
              frameworks for future participation in lawful precious metals
              markets. All activities are designed to operate within principles
              of strong governance, transparency, and accountability.
            </p>
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              <Link
                to="/contact"
                className="bg-hbrz-gold text-white px-10 py-5 rounded-sm font-bold text-center hover:bg-[#D4AF37] transition-all shadow-xl uppercase tracking-wider text-sm"
              >
                Engage Our Services
              </Link>
              <Link
                to="/compliance"
                className="border border-white/40 text-white px-10 py-5 rounded-sm font-bold text-center hover:bg-white hover:text-hbrz-blue transition-all uppercase tracking-wider text-sm backdrop-blur-sm"
              >
      ...
      <section className="py-32 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mb-24">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-hbrz-blue mb-8">
              What We Do
            </h2>
            <p className="text-lg text-gray-600 leading-relaxed font-light">
              HBRZ Global Purity Trading and Consulting Services Ltd, together
              with its affiliated U.S. entity, HBRZ Global Purity Trading and
              Consulting Services LLC (Delaware and Virginia), is structured to
              provide institutional consulting and advisory services, as well as
              governance-aligned coordination support for lawful commodity
              market participation and general information technology (IT)
              advisory. All activities are designed to be delivered within
              strong governance frameworks, compliance discipline, and
              systems-based operating models.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="text-4xl font-bold text-hbrz-blue mb-6">
                Built on <span className="text-hbrz-gold">Governance</span>
              </h2>
              <p className="text-gray-600 mb-10 leading-relaxed font-light text-lg">
                Our approach is defined by professionalism, institutional
                discipline, and a commitment to long-term value creation.
                Operating on an arm’s-length basis, we ensure that all advisory
                engagements and operational support activities are delivered
                through transparent, accountable, and well-governed processes.
              </p>
              <Link
                to="/about"
                className="inline-block text-xs font-bold text-hbrz-gold uppercase tracking-[0.2em] border-b-2 border-hbrz-gold pb-1 hover:text-hbrz-blue hover:border-hbrz-blue transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center justify-center space-x-4 mb-8">
              <div className="h-px w-12 bg-hbrz-gold"></div>
              <span className="text-hbrz-gold font-bold uppercase tracking-[0.4em] text-xs">
                Governance & Alignment
              </span>
              <div className="h-px w-12 bg-hbrz-gold"></div>
            </div>
            <h3 className="text-2xl md:text-3xl font-bold text-hbrz-blue leading-relaxed">
              Governance-led advisory and coordination services aligned with
