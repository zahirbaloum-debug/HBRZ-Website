    ...
    <div className="animate-fadeIn">
      ...
      <section className="bg-hbrz-blue py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            Our <span className="text-hbrz-gold">People</span>
          </h1>
          <p className="text-xl text-gray-300 font-light max-w-2xl mx-auto leading-relaxed">
            HBRZ is governed by an esteemed Board of Directors and led by an
            executive team of industry professionals dedicated to integrity and
            excellence.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="lg:col-span-5 lg:sticky lg:top-24">
                ...
                <div className="mt-8 p-8 bg-gray-50 border border-gray-100 shadow-sm relative overflow-hidden">
                  ...
                  <h5 className="text-hbrz-blue font-bold text-xs uppercase tracking-widest mb-4">
                    Executive Mandate
                  </h5>
              ...
              <div className="lg:col-span-7 pt-4">
                <div className="max-w-2xl">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <span className="text-hbrz-gold font-bold uppercase tracking-[0.3em] text-xs">
                      Principal Leadership
                    </span>
                  </div>
                  <h2 className="text-4xl md:text-6xl font-bold text-hbrz-blue mb-4 leading-tight">
                    {leadership[0].name}
                  </h2>
                  <h3 className="text-2xl text-hbrz-gold font-light mb-12 uppercase tracking-wide">
                    {leadership[0].pos}
                  </h3>
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="p-8 bg-hbrz-blue text-white rounded-sm shadow-lg">
                      <p className="text-lg font-light leading-relaxed italic">
                        "Known for balancing capital discipline with growth
                        strategies to advance governance-led organizational
                        performance."
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                      <div>
                        <h5 className="text-hbrz-blue font-bold text-xs uppercase tracking-widest mb-6 border-b border-gray-100 pb-2">
                          Geographic & Institutional Exposure
                        </h5>
                        <ul className="text-gray-500 text-sm space-y-4 font-light">
                          <li className="flex items-start">
                            ...
                            <span>
                              United States, Africa, Asia, Eastern Europe, and
                          ...
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-hbrz-gold rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                            <span>
                              Funding partners and philanthropic organizations.
                            </span>
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul className="text-gray-500 text-sm space-y-4 font-light">
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-hbrz-gold rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                            <span>
                              Healthcare systems and power distribution
                              infrastructure
                            </span>
                          </li>
                          <li className="flex items-start">
                          ...
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-hbrz-gold rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                            <span>
                              Food, beverage, and agriculture value chains
                            </span>
                          </li>
                          <li className="flex items-start">
                            <span className="w-1.5 h-1.5 bg-hbrz-gold rounded-full mt-1.5 mr-3 flex-shrink-0"></span>
                            <span>
                              Microinsurance and trade-supporting institutional
                              environments
                            </span>
                          </li>
                        </ul>
                    ...
                    <div className="pt-8 border-t border-gray-100">
                      <h5 className="text-hbrz-blue font-bold text-xs uppercase tracking-widest mb-8">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {[
                          ...
                          <div
                            key={item}
                            className="p-4 bg-gray-50 border border-gray-100 text-[10px] font-bold text-gray-400 uppercase tracking-wider text-center group hover:bg-hbrz-gold hover:text-white transition-all cursor-default"
                          >
                            {item}
                          </div>
                        ))}
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
              ...
              <h3 className="text-3xl font-bold text-hbrz-blue mb-4 uppercase tracking-tight">
                Board of Directors
              </h3>
              ...
              <p className="mt-6 text-gray-500 font-light max-w-2xl mx-auto text-sm">
                ...
                governance, risk management, and strategic direction of HBRZ
                Global Purity.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {boardOfDirectors.map((director, idx) => (
                <div
                  key={idx}
                  className="p-10 border border-gray-100 bg-gray-50 hover:bg-white hover:shadow-xl transition-all duration-300 rounded-sm relative group"
                >
                  ...
                  {director.name && (
                    <h4 className="text-hbrz-blue font-bold text-xl mb-1">
                      {director.name}
                    </h4>
                  )}
                  <h5
                    className={`${director.name ? 'text-hbrz-gold text-xs font-bold uppercase tracking-widest' : 'text-hbrz-blue font-bold text-lg uppercase tracking-wider'} mb-4 border-b border-gray-200 pb-3`}
                  >
                    {director.pos}
                  </h5>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {leadership.slice(1).map((person, idx) => (
                <div
                  key={idx}
                  className="group p-10 border border-gray-100 bg-white hover:bg-gray-50 transition-all duration-300 shadow-sm flex flex-col justify-between"
                >
                  <div>
                    {person.name && (
                      <h4 className="text-hbrz-blue font-bold text-xl mb-1">
                    ...
                    <h5
                      className={`${person.name ? 'text-hbrz-gold text-xs font-bold uppercase tracking-widest' : 'text-hbrz-blue font-bold text-base uppercase tracking-wider'} mb-4 border-b border-gray-100 pb-3`}
                    >
                      {person.pos}
                    </h5>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="p-12 bg-hbrz-blue text-white rounded-sm shadow-xl">
              <h4 className="text-hbrz-gold font-bold uppercase tracking-widest text-xs mb-6">
                Professional Rigor
              </h4>
              <p className="text-gray-300 font-light leading-relaxed">
                Our professionals are selected for their commitment to high
                standards of governance, ethics, and disciplined execution. We
                believe professional excellence is achieved through continuous
                development in institutional best practices, regulatory
                awareness, and systems-based advisory methodologies. Every HBRZ
                leader upholds the Company’s principles of transparency,
                accountability, and professional integrity in all engagements.
              </p>
            </div>
            <div className="p-12 bg-white border border-gray-200 rounded-sm">
              <h4 className="text-hbrz-blue font-bold uppercase tracking-widest text-xs mb-6">
                Institutional Discipline
              </h4>
              <p className="text-gray-600 font-light leading-relaxed">
                We foster a culture of discipline across all advisory and
                operational activities. Our leadership team ensures that
                strategic decisions and service delivery are aligned with the
                Company’s governance frameworks, professional standards, and
                applicable regulatory and compliance expectations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <svg
            className="w-12 h-12 text-hbrz-gold mx-auto mb-6"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
          ...
          <p className="text-hbrz-blue font-bold text-sm uppercase tracking-[0.3em] mb-4">
            Verification & Transparency
          </p>
          <p className="text-gray-400 font-light leading-relaxed text-sm max-w-2xl mx-auto italic">
            "The HBRZ executive board undergoes regular independent auditing and
            vetting to maintain the absolute institutional integrity of our
